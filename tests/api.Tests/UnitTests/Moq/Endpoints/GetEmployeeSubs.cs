...
namespace MD.Salary.WebApi.Tests.UnitTests.Moq
{
    public class GetEmployeeSubs : EmployeesControllerTests
    {
        ...
        {
            // Act
            var actResult = GetAsyncActionResult(() => _controller.GetEmployeeSubs(2000, 1564952400));
        ...
        {
            // Act
            var actResult = GetAsyncActionResult(() => _controller.GetEmployeeSubs(1001, 1564952400));
